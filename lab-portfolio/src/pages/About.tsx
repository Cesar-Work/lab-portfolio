    ...
    <div className="mx-auto max-w-3xl px-4 mt-10">
      <div className="panel rounded-2xl p-6">
        ...
        <p className="text-sm text-gray-300 leading-7">
          I am Cesar Francis, a first-year CS student at the Lebanese University. I like building
          things that feel fast and minimal. My favorite toys: React, TypeScript, Python and C.
        </p>
